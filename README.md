...
---
## Notice! 
> - 서버이전 및 안정화 작업 관계로 `2022.1.8 ~ 2.7` 약 한달간 `TEANAPS` OPEN API가 중단됩니다. 그 외 `TEANAPS` 라이브러리는 정상적으로 사용 가능합니다.
...
> - `TEANAPS`를 활용한 텍스트 분석 실무/연구 프로젝트 **지원이 필요하신 분**, 또는 **사례 공유가 가능하신 분**의 연락을 기다립니다.     
